    ...
    public function get_all_stores(Request $request)
{
    ...
    {
        \Log::info('sendEmailClient called', [
        ...
        try {
            ...
            \Log::error('Validation error in sendEmailClient', [
            ...
            \Log::error('Error in sendEmailClient', [
            ...
            if ($request->ajax() || $request->wantsJson() || $request->expectsJson()) {
                return response()->json([
                    'success' => false,
                    'message' => 'Problème de connexion: ' . $e->getMessage()
                ], 500);
            }

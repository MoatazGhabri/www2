...
$timestamp = "_az". rand(1,999999999);
    ...
    public function update(Request $request, PromoteurProperty $property)
    {
        ...
        try {
            ...
            $property->remise_des_clés = $request->remise_des_clés;
            // price
            $property->price_total = $request->prixtotaol ?: null;
            $property->price_metre = $request->price_metre ?: null;
            $property->price_metre_terrasse = $request->pricem²_terass ?: null;
            $property->price_metre_jardin = $request->pricem²_garden ?: null;
            $property->price_cellier = $request->price_cellier ?: null;
            $property->price_parking = $request->price_parking ?: null;
            //surface
            $property->surface_totale = $request->surface_total ?: null;
            $property->surface_habitable = $request->surface_habitable ?: null;
            $property->surface_terrasse = $request->surface_terrasse ?: null;
            $property->surface_jardin = $request->surface_jardin ?: null;
            $property->surface_cellier = $request->surface_cellier ?: null;
            //locatioin
            $property->city_id = $request->city_id;
            $property->area_id = $request->area_id;
            $property->address = $request->address;
            $property->map_embed_url = $request->map_embed_url;
            // $property->code = $request->code;
            $property->nb_bedroom = $request->room_number ?: 0;
            $property->nb_living = $request->living_room_number ?: 0; //oui
            $property->nb_bathroom = $request->bath_room_number ?: 0;
            $property->nb_kitchen = $request->kitchen_number ?: 0;
            $property->nb_terrasse = $request->teras_number ?: 0;
            $property->nb_etage = $request->etage ?: 0;
            $property->status = 0;

            $property->salle_eau = $request->sal_eau_number ?: 0;

            $property->suite_parental = $request->suite_parental ?: 0;

...
<div class="modern-register-container">
    ...
    <div class="register-hero">
        <div class="hero-overlay">
            ...
            <p>Proposez vos services professionnels à des milliers de clients</p>
        </div>
    </div>
    ...
    <div class="register-form-container">
        <div class="register-form-wrapper">
            ...
            <form action="{{ route('service_user.register') }}" method="POST" class="modern-register-form">
                @csrf
...
<style>
    ...
    .register-hero {
        flex: 1;
        background: linear-gradient(135deg, #03ba18, #028a12);
    ...
    .register-form-container {
        ...
        padding: 2rem;
        background: #f8fafc;
        margin-top: 110px; /* Add this line (adjust value to your header height) */
    }
    ...
    .form-input:focus {
        outline: none;
        border-color: #03ba18;
        box-shadow: 0 0 0 3px rgba(3, 186, 24, 0.2);
    }
    ...
    .register-button:hover {
        ...
        box-shadow: 0 4px 12px rgba(3, 186, 24, 0.3);
    }

        ...
        <div class="user-profile-card">
            ...
            <div class="col-lg-12">
                <div class="post-ad-form">
                    ...
                    <form action="{{ route('update_admin_property', $property[0]) }}" method="POST"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="form-section">
                                ...
                                @include('dasboard_users.properties.include.edit_property_image.upload-vedio')
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="url" class="form-control @error('map_embed_url') is-invalid @enderror"
                                    placeholder="Collez ici le lien d'intégration Google Maps" name="map_embed_url" value="{{ $property[0]['map_embed_url'] ?? old('map_embed_url') }}">
                            ...
                            <br> --}}
                            <h4 class="fw-bold my-2">Caractéristiques</h4>
                            ...
                            <input type="hidden" name="return_url" value="company_property">
    ...
    <script >
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-image', function() {
                ...
                // console.log(userURL);
                var imageId = $(this).data('id');
                var trObj = $(this).closest('tr'); // Assuming the image is inside a table row
                console.log(trObj)
                
                if (confirm("Êtes-vous sûr de vouloir supprimer cette image?")) {
                // console.log("ttt"+userURL);

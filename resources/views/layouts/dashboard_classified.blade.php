...
<head>
    ...
    <meta name="description" content="Clé Du Bonheur - Administration Dashboard Classifieds - Gestion des petites annonces immobilières à Tunis">
    <meta name="keywords" content="Clé Du Bonheur, administration, petites annonces, immobilier, Tunis, gestion annonces">
    <meta name="author" content="Clé Du Bonheur">
    <meta name="robots" content="noindex, nofollow">
    {{-- @csrf --}}
    <meta name="csrf-token" content="{{ csrf_token() }}">

                    <title>Clé Du Bonheur - @yield('pageTitle')</title>

    <!-- favicon -->
            <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/logo/bonheur.png') }}">
    ...
    @include("includes.image_page")
        <div class="user-profile py-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
                        @include("dashboard_classified.includes.side_bar_dashboard")

...
.site-title {
    font-size: 3.5rem;
    font-weight: 800;
    background: linear-gradient(135deg, #055408 0%, #055408 50%, #055408 100%);
...
.site-title::after {
    ...
    width: 80px;
    height: 4px;
    background: linear-gradient(90deg, #055408, #055408);
    border-radius: 2px;
}
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card shadow-sm border-0 h-100 service-item" style="border-radius: 20px; transition: transform 0.2s;">
                    <div class="card-body text-center d-flex flex-column align-items-center justify-content-center" style="padding: 2rem;">
                        ...
                        <h4 class="mt-2 mb-2" style="font-weight: 700; color: #055408;">{{ ucfirst($item->title) }}</h4>

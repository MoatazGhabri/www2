                    ...
                    <form action="{{ route('update_property', $property[0]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="url" class="form-control @error('map_embed_url') is-invalid @enderror"
                                placeholder="Collez ici le lien d'intégration Google Maps" name="map_embed_url"
                                value="{{ old('map_embed_url', $property[0]['map_embed_url'] ?? '') }}">
                                ...
                                @if($property[0]->vedio_path)
                                    <div class="col-lg-12 mt-2 mb-2">
                                        <video width="320" height="240" controls>
                                            <source src="{{ asset('uploads/videos/properties/' . $property[0]->vedio_path) }}" type="video/mp4">

                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Nom de la résidence/lotissement
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="" name="surface_habitable">
                                </div>
                                @include('message_session.error_field_message', [
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="" name="surface_terrasse">
                                </div>
                                @include('message_session.error_field_message', [
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="" name="surface_jardin">
                                </div>
                                @include('message_session.error_field_message', [
...
@include('dasboard_users.properties.include.upload-vedio')
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        ...
                                        <ol style="margin-top: 5px; padding-left: 20px;">
                                            ...
                                            <li>Copiez l'URL dans src="..." (Noter bien ne copier pas le src, juste son contenu)</li>
                                        </ol>
                                    </small>
                                </div>
                                @include('message_session.error_field_message', [
                            ...
                            <div class="col-6 mt-4">
                                <div class="form-check">
                                    <input class="form-check-input" name="heating" type="checkbox"
                                        value="1" id="heating" >

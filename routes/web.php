...
Route::get('/cherche/-{operation?}-{city?}-{area?}', [PropertyController::class, 'searchByOperation'])->name('search.operation');
Route::get('/cherche/{category?}-{operation?}-{city?}-{area?}', [PropertyController::class, 'searchByCategory'])->name('search.category');
...
// ------------------------promoteur messages--------------------------------
Route::post('/send-message-promoteur', [App\Http\Controllers\PromoteurMessageController::class, 'sendMessage'])->name('send.message.promoteur');
// ------------------------end promoteur messages--------------------------------
...
Route::get('/propertie_by_id/{id}', [PropertyController::class, 'get_prop_info_by_id'])->name('prop_info_by_id');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    //-----------------------------------------------promoteur messages--------------------------------------------
    Route::get('/promoteur/messages', [App\Http\Controllers\PromoteurMessageController::class, 'index'])->name('promoteur.messages.index');
    Route::get('/promoteur/messages/{id}', [App\Http\Controllers\PromoteurMessageController::class, 'show'])->name('promoteur.messages.show');
    Route::post('/promoteur/messages/{id}/mark-read', [App\Http\Controllers\PromoteurMessageController::class, 'markAsRead'])->name('promoteur.messages.mark-read');
    Route::post('/promoteur/messages/{id}/mark-replied', [App\Http\Controllers\PromoteurMessageController::class, 'markAsReplied'])->name('promoteur.messages.mark-replied');
    Route::delete('/promoteur/messages/{id}', [App\Http\Controllers\PromoteurMessageController::class, 'destroy'])->name('promoteur.messages.destroy');
    Route::get('/promoteur/messages/unread-count', [App\Http\Controllers\PromoteurMessageController::class, 'getUnreadCount'])->name('promoteur.messages.unread-count');
    // Bulk actions
    Route::post('/promoteur/messages/bulk/mark-read', [App\Http\Controllers\PromoteurMessageController::class, 'markAsRead'])->name('promoteur.messages.bulk.mark-read');
    Route::post('/promoteur/messages/bulk/mark-replied', [App\Http\Controllers\PromoteurMessageController::class, 'markAsReplied'])->name('promoteur.messages.bulk.mark-replied');
    Route::delete('/promoteur/messages/bulk/delete', [App\Http\Controllers\PromoteurMessageController::class, 'destroy'])->name('promoteur.messages.bulk.delete');
    //-----------------------------------------------end promoteur messages--------------------------------------------
    ...
    Route::match(['get', 'post'], '/admin/all_properties', [AdminController::class, 'get_admin_properties'])->name('admin_all_properties');
...
// Block all registration routes
Route::match(['get', 'post'], '/register', function() { return redirect('/login'); });
Route::match(['get', 'post'], '/register/annonceur_immobilier', function() { return redirect('/login'); });
Route::match(['get', 'post'], '/service_user/register', function() { return redirect('/login'); });
Route::match(['get', 'post'], '/classifed_user/register', function() { return redirect('/login'); });
Route::match(['get', 'post'], '/register_classified', function() { return redirect('/login'); });

Route::post('/send-email-admin', [App\Http\Controllers\PublicMessageController::class, 'receiveAdminMessage'])->name('send.email.admin');

// Test route for debugging
Route::post('/test-ajax', function(Request $request) {
    return response()->json([
        'success' => true,
        'message' => 'Test AJAX works!',
...
Route::get('/admin/messages', [App\Http\Controllers\Admin\AdminController::class, 'adminMessages'])->name('admin.messages');

Route::delete('/admin/messages/{message}', [App\Http\Controllers\Admin\AdminController::class, 'deleteMessage'])->name('admin.messages.delete');

Route::get('/admin/messages/{message}', [App\Http\Controllers\Admin\AdminController::class, 'showAdminMessage'])->name('admin.messages.show');

Route::post('/admin/messages/{message}/mark-read', [App\Http\Controllers\Admin\AdminController::class, 'markAdminMessageRead'])->name('admin.messages.mark-read');
Route::post('/admin/messages/{message}/mark-replied', [App\Http\Controllers\Admin\AdminController::class, 'markAdminMessageReplied'])->name('admin.messages.mark-replied');

Route::prefix('admin')->name('admin.')->group(function () {
    Route::resource('mandats', App\Http\Controllers\Admin\MandatController::class);
    Route::resource('prospect_contacts', App\Http\Controllers\Admin\ProspectContactController::class);
});
